#############################################################################
# Makefile for building: SHAPES-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: mar. 22. juil. 16:03:48 2014
# Project:  SHAPES-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile SHAPES-qt.pro
#############################################################################
...
Makefile: SHAPES-qt.pro  ../../../Qt/4.8.5/mkspecs/default/qmake.conf ../../../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile SHAPES-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/dev/SHAPES/SHAPES/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/dev/SHAPES/SHAPES/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/dev/SHAPES/SHAPES/src/leveldb/libleveldb.a: FORCE
